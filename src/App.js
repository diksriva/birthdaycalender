...
import './App.css';
import WeekdayComponent from './component/weekday'
    ...
    for (let i = 0; i < data.length; i++) {
      ...
      if (data[i].birthday.trim() !== "" && data[i].name.trim() !== "") {
        if (day === "Monday") {
          ...
          tue.push({ dateobj, initials })
        }
        else if (day === "Wednesday") {
          wed.push({ dateobj, initials })
        }
        else if (day === "Thursday") {
          thus.push({ dateobj, initials })
        }
        else if (day === "Friday") {
          fri.push({ dateobj, initials })
        }
        else if (day === "Saturday") {
          sat.push({ dateobj, initials })
        }
        else if (day === "Sunday") {
          sun.push({ dateobj, initials })
        }
      }
    }
    setWeekdays({
